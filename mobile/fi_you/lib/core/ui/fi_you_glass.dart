...
class FiYouGlass {
  ...
  static BoxDecoration transparentGlassV5({
    ...
    final fillAlpha = pressed
        ...
        : switch (resolvedPreset) {
            FiYouGlassV5Preset.large => 0.038,
            FiYouGlassV5Preset.medium => 0.04,
            FiYouGlassV5Preset.small => 0.035,
    ...
    final borderAlpha = switch (resolvedPreset) {
      ...
      FiYouGlassV5Preset.medium => 0.21,
    ...
    final shadowAlpha = pressed ? 0.075 : 0.06;
    return BoxDecoration(
      color: isButton
  ...
  static BoxDecoration nativeBarDecoration({double radius = 32}) {
    return BoxDecoration(
      color: nativeBarAccent.withValues(alpha: 0.08),
      borderRadius: BorderRadius.circular(radius),
      border: Border.all(
        color: nativeBarAccent.withValues(alpha: 0.24),
        width: 0.9,
      ),
      boxShadow: [
        BoxShadow(
  ...
  Widget build(BuildContext context) {
    final child = Container(
      ...
      decoration: FiYouGlass.smallGlassV5(
        ...
        borderColor: showBorder ? color : FiYouGlass.glassStrokeSide,
      ),
      child: Icon(Icons.chevron_right_rounded, color: color, size: iconSize),
    );
