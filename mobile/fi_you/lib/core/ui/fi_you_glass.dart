...
class FiYouGlass {
  ...
  static const glassFillLarge = Color(0x04FFFFFF);
  static const glassFillMedium = Color(0x05FFFFFF);
  static const glassFillSmall = Color(0x06FFFFFF);
  static const glassFillCta = Color(0x05FFFFFF);
  ...
  static const glassV5Fill = Color(0x04FFFFFF);
  static const glassV5PressFill = Color(0x07FFFFFF);
  static const glassV5Border = Color(0x29FFFFFF);
  static const glassV5BorderSoft = Color(0x1FFFFFFF);
  static const glassV5Shadow = Color(0x0A000000);
  static const buttonTint = Color(0x147DD3FC);
  static const buttonTintPressed = Color(0x1F7DD3FC);
  static const buttonBorder = Color(0x667DD3FC);
  static const buttonBorderSoft = Color(0x4D7DD3FC);
  ...
  static BoxDecoration transparentGlassV5({
    ...
    final fillAlpha = pressed
        ...
        : switch (resolvedPreset) {
            FiYouGlassV5Preset.large => 0.016,
            FiYouGlassV5Preset.medium => 0.018,
            FiYouGlassV5Preset.small => 0.022,
            FiYouGlassV5Preset.cta => 0.02,
            FiYouGlassV5Preset.nav => 0.02,
          };
    final isButton = resolvedPreset == FiYouGlassV5Preset.cta;
    final borderAlpha = switch (resolvedPreset) {
      FiYouGlassV5Preset.large => 0.15,
      FiYouGlassV5Preset.medium => 0.16,
      FiYouGlassV5Preset.small => 0.17,
      FiYouGlassV5Preset.cta => 0.18,
      FiYouGlassV5Preset.nav => 0.14,
    };
    final shadowAlpha = pressed ? 0.065 : 0.045;
    return BoxDecoration(
      color: isButton
      ...
      border: Border.all(
        ...
        width: isButton
            ? 1.15
            : resolvedPreset == FiYouGlassV5Preset.large
            ? 1
            : 0.9,
      ),
      boxShadow: [
  ...
  static BoxDecoration nativeBarDecoration({double radius = 32}) {
    return transparentGlassV5(radius: radius, preset: FiYouGlassV5Preset.nav);
  }
